                ...
                >
                    ...
                    <div className="space-y-4 h-full overflow-auto relative">
                        <div className="bg-black/50 border border-red-500 rounded-lg p-4">
                            ...
                            <div className="h-[400px] border border-red-400 rounded overflow-hidden">
                                <Editor
                                    height="100%"
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            ...
                            <div className="bg-black/50 border border-red-500 rounded-lg p-4">
                                ...
                                <textarea
                                    ...
                                    className="w-full h-[150px] bg-black/30 border border-red-400 rounded p-2 text-white resize-none focus:ring-1 focus:ring-red-500 focus:border-red-500"
                                ...
                                <div className="h-[150px] bg-black/30 border border-red-400 rounded p-2 overflow-auto">
                                    {output ? (
                                        <pre className={`text-sm whitespace-pre-wrap ${
                                            output.error ? 'text-red-500' : 'text-green-400'
                                        }`}>
